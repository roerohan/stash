  ...
  return (
    <div className="max-w-6xl mx-auto">
        ...
        <div className="text-sm text-gray-400 mb-4">
            Language: {paste.language || 'plaintext'} | Visibility: {paste.visibility ? paste.visibility.charAt(0).toUpperCase() + paste.visibility.slice(1) : 'Public'} | Posted: {new Date(paste.created_at).toLocaleString()}
        </div>
